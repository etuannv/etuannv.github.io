...
---
**Xem thêm:**
- [AI Thu Thập Lead — từ form đến CRM trong 30 giây](https://etuannv.com/vi/projects/n8n-ai-lead-capture-airtable/) — workflow Cấp 1–5 mà bài này lấy ví dụ từ đó
- [AI Email Triage — tự động phân loại và ưu tiên hộp thư của bạn](https://etuannv.com/vi/projects/ai-email-triage-n8n-claude/) — workflow phân loại Cấp 1–3
